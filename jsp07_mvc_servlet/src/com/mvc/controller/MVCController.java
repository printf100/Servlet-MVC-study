...
public class MVCController extends HttpServlet {
	...
	private void insert() {
		...
		if(biz.insert(dto) > 0) {
			...
			out.println("location.href='MVCController?command=boardList';");
			out.println("</script>");
			out.close();
	...
	private void update() {
		...
		if(biz.update(dto) > 0) {
			...
			out.println("location.href='MVCController?command=updateForm&SEQ='" + seq);
			out.println("</script>");
			out.close();
	...
	private void delete() {
		...
		if(biz.delete(seq) > 0) {
			...
			out.println("location.href='MVCController?command=boardContent&SEQ='" + seq);
			out.println("</script>");
			out.close();
			//view = "MVCController?command=boardContent&SEQ=" + seq;
		}
