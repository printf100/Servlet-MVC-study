...
%>
			<tr>
				...
				<td><%= dto.getSeq() %></td>
				<td><%= dto.getWriter() %></td>
				<td><a href="MVCController?command=boardContent&SEQ=<%= dto.getSeq() %>"><%= dto.getTitle() %></a></td>
...
%>
			...
			<tr>
				<td colspan="5" align="right">
					...
					<input type="button" value="글쓰기" onclick="location.href='MVCController?command=writeForm'">
				</td>
			</tr>
