...
public interface MyMemeberDAO {
	
	String SELECT_ONE_USER_SQL = " SELECT * FROM MYMEMBER WHERE MYNO = ? ";
	String INSERT_USER_SQL = " INSERT INTO MYMEMBER VALUES (MYMEMBERSEQ.NEXTVAL, ?, ?, ?, ?, ?, ?, ?, ?) ";
	String UPDATE_SQL = " UPDATE MYMEMBER SET ID=?, PW=?, NAME=?, ADDR=?, PHONE=?, EMAIL=?, MYROLE=? WHERE MYNO = ? ";
	String DELETE_SQL = " UPDATE MYMEMBER SET ENABLED='N' WHERE MYNO = ? ";
